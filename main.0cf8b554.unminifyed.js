!(function (t) {
        ...
        !(function () {
            ...
            (o.prototype.defaults = {
                ...
                ($.prototype.isMobile = function () {
                    return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(nav1igator.userAgent);
                }),
                (A =
    ...
    JkW7: function (t, e, n) {
        ...
        !(function (t) {
            ...
            Object.assign(window, { nav1bar1FixedTopAnimation: i.b, scrollRevelation: i.c, nav1ActivePage: i.a });
    },
    Kz47: function (t, e, n) {
    ...
    aWFY: function (t, e, n) {
        ...
        (function (t) {
            function i() {
                var e = 0;
                t(".nav1bar1-default").removeClass("active").addClass("nav1bar1-fixed-top"),
                    t(document).scroll(function () {
                        if ((e = t(this).scrollTop()) > 440) t(".nav1bar1-default").addClass("active");
                        else {
                            if (t(".nav1bar1-default").hasClass("home") && t(".nav1bar1-collapse").hasClass("in")) return;
                            t(".nav1bar1-default").removeClass("active");
                        }
                    }),
                    t(".nav1bar1-toggle").click(function (n) {
                        t(".nav1bar1-default").hasClass("active") ? t(".nav1bar1-default").hasClass("home") && e < 440 && t(".nav1bar1-default").removeClass("active") : t(".nav1bar1-default").addClass("active home");
                    }),
                    t(window).resize(function () {
                        var e = window.innerWidth;
                        t(".nav1bar1-default").hasClass("home") && t(".nav1bar1-collapse").hasClass("in") && (e > 767 ? t(".nav1bar1-default").removeClass("active") : t(".nav1bar1-default").addClass("active"));
                    });
            }
            function o(t) {
            ...
            function r() {
                t('nav1 li a[href=".' + location.pathname + '"]').addClass("active"), "/" == location.pathname && t('nav1 li a[href="./index.html"]').addClass("active");
            }
            n.d(e, "b", function () {
                return i;
            }),
            ...
            +(function (t) {
                ...
                (e.prototype.listen = function () {
                    ...
                    (e.prototype._activeZoomClose = function (t) {
                        this._activeZoom &&
                            (t ? this._activeZoom.dispose() : this._activeZoom.close(), this._$window.off(".zoom"), this._$document.off(".zoom"), document.removeEventListener("click", this._boundClick, !0), (this._activeZoom = null));
                    }),
                    ...
                    (n.prototype._triggerAnimation = function () {
                        ...
                        t.support.transition && (l += " translateZ(0)"),
                            t(this._targetImage).css({ "-webkit-transform": a, "-ms-transform": a, transform: a }),
                            t(this._targetImageWrap).css({ "-webkit-transform": l, "-ms-transform": l, transform: l }),
                            this._$body.addClass("zoom-overlay-open");
                    }),
                    (n.prototype.close = function () {
                        return (
                            this._$body.removeClass("zoom-overlay-open").addClass("zoom-overlay-transitioning"),
                            t(this._targetImage).css({ "-webkit-transform": "", "-ms-transform": "", transform: "" }),
                            t(this._targetImageWrap).css({ "-webkit-transform": "", "-ms-transform": "", transform: "" }),
                    ...
                    (n.prototype.dispose = function () {
                        this._targetImageWrap &&
                            ...
                            (t(this._targetImage).removeClass("zoom-img").attr("data-action", "zoom"),
            ...
            +(function (t) {
                ...
                function e(n, i) {
                    (this.$body = t(document.body)),
                        ...
                        (this.selector = (this.options.target || "") + " .nav1 li > a"),
                        (this.offsets = []),
                        (this.targets = []),
                    ...
                    (s.prototype.toggle = function (i) {
                        ...
                        if (!o.is(".disabled, :disabled")) {
                            var r = e(o),
                                s = r.hasClass("open");
                            if ((n(), !s)) {
                                "ontouchstart" in document.documentElement && !r.closest(".nav1bar1-nav1").length && t(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(t(this)).on("click", n);
        ...
        !(function (e, n) {
            ...
            function x(t, e) {
                for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
                    (i = t[r]),
                        i.style &&
                            ((n = i.style.display),
                            e ? ("none" === n && ((o[r] = Pt.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && Ut(i) && (o[r] = w(i))) : "none" !== n && ((o[r] = "none"), Pt.set(i, "display", n)));
            ...
            function W(t, e, n, i, o) {
                ...
                for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
                    "margin" === n && (s += yt.css(t, n + Bt[r], !0, o)),
                        i
                            ? ("content" === n && (s -= yt.css(t, "padding" + Bt[r], !0, o)), "margin" !== n && (s -= yt.css(t, "border" + Bt[r] + "Width", !0, o)))
                            : ((s += yt.css(t, "padding" + Bt[r], !0, o)), "padding" !== n && (s += yt.css(t, "border" + Bt[r] + "Width", !0, o)));
                return s;
            }
            function M(t, e, n) {
                var i,
                ...
                return ce.test(r)
                    ? r
                    : ((i = s && (vt.boxSizingReliable() || r === t.style[e])), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + W(t, e, n || (s ? "border" : "content"), i, o) + "px");
            }
            ...
            function X(t, e, n) {
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(p)) {
                    ...
                    for (i in p)
                        l ||
                            (m ? "hidden" in m && (g = m.hidden) : (m = Pt.access(t, "fxshow", { display: c })),
                            r && (m.hidden = !g),
                            g && x([t], !0),
                            d.done(function () {
            ...
            var Ct = (function (t) {
                ...
                (w = e.support = {}),
                    ...
                    (D = e.setDocument = function (t) {
                        ...
                        return i !== j && 9 === i.nodeType && i.documentElement
                            ? ((j = i),
                              ...
                              (w.matchesSelector = ht.test((q = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector))) &&
                                  o(function (t) {
                    ...
                    (e.matchesSelector = function (t, n) {
                        if (((t.ownerDocument || t) !== j && D(t), (n = n.replace(lt, "='$1']")), w.matchesSelector && O && !B[n + " "] && (!L || !L.test(n)) && (!_ || !_.test(n))))
                            try {
                                var i = q.call(t, n);
                                    ...
                                    : function (e, n, l) {
                                          ...
                                          if (m) {
                                              ...
                                              if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
                                                  for (
                                                      d = m, f = d[P] || (d[P] = {}), u = f[d.uniqueID] || (f[d.uniqueID] = {}), c = u[t] || [], p = c[0] === H && c[1], b = p && c[2], d = p && m.childNodes[p];
                                                  ...
                                                  for (
                                                      ;
                                                      (d = (++p && d && d[g]) || (b = p = 0) || h.pop()) &&
                                                      ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((f = d[P] || (d[P] = {})), (u = f[d.uniqueID] || (f[d.uniqueID] = {})), (u[t] = [H, b])), d !== e));
            ...
            yt.extend({
                ...
                clone: function (t, e, n) {
                    ...
                    if (e)
                        if (n) for (r = r || T(t), s = s || T(a), i = 0, o = r.length; i < o; i++) I(r[i], s[i]);
                        else I(t, a);
            ...
            yt.extend({
                ...
                style: function (t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        (r = typeof n),
                            "string" === r && (o = zt.exec(n)) && o[1] && ((n = b(t, e, o)), (r = "number")),
                            null != n &&
                                n === n &&
                    ...
                    attr: function (t, e, n) {
                        ...
                        if (3 !== r && 8 !== r && 2 !== r)
                            return void 0 === t.getAttribute
                                ? yt.prop(t, e, n)
                                : ((1 === r && yt.isXMLDoc(t)) || (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? xe : void 0)),
                                  void 0 !== n
                                      ? null === n
                    ...
                    if (
                        ...
                        for (r = 0; (s = d[r++]) && !t.isPropagationStopped(); )
                            (t.type = r > 1 ? l : f.bindType || p),
                                ...
                                u && u.apply(s, e),
                                (u = c && s[c]) && u.apply && Rt(s) && ((t.result = u.apply(s, e)), !1 === t.result && t.preventDefault());
                        return (
                            (t.type = p),
                            o ||
                    ...
                    ajax: function (t, e) {
                        function i(t, e, i, a) {
                            ...
                            u ||
                                ...
                                (w = ot(h, w, C, c)),
                                c
                                    ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")), x && (yt.lastModified[r] = x), (x = C.getResponseHeader("etag")) && (yt.etag[r] = x)),
                        ...
                        (f = yt.event && h.global),
                            ...
                            (r = h.url.replace(Le, "")),
                            h.hasContent
                                ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(_e, "+"))
                                : ((p = h.url.slice(r.length)),
                                  h.data && ((r += (Ae.test(r) ? "&" : "?") + h.data), delete h.data),
                                  !1 === h.cache && ((r = r.replace(qe, "$1")), (p = (Ae.test(r) ? "&" : "?") + "_=" + Ne++ + p)),
                                  (h.url = r + p)),
